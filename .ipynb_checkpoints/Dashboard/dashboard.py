...
try:
    ...
    st.error(f"Error creating monthly income chart: {str(e)}")
...
try:
    ...
    st.error(f"Error creating most sold products chart: {str(e)}")
...
try:
    ...
    st.error(f"Error creating order status distribution chart: {str(e)}")
...
try:
    ...
    st.error(f"Error creating detailed order status distribution chart: {str(e)}")
...
with tab1:
    try:
        ...
        st.error(f"Error creating state distribution chart: {str(e)}")
